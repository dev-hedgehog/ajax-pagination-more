...
class Customizer
{
    ...
    public function addSection($wp_customize){
        ...
        $wp_customize->add_panel( 'ajax_pagination_settings', array(
            'title'      => __('Ajax Pagination Settings', 'ajax-pagination-more'),
            'priority'   => 200,
        ) );
        $wp_customize->add_section( 'wpap_loading_effects' , array(
            'title'      => __('Loading effects', 'ajax-pagination-more'),
            'panel' => 'ajax_pagination_settings',
        ) );
        $wp_customize->add_section( 'wpap_button_settings' , array(
            'title'      => __('Button settings', 'ajax-pagination-more'),
            'panel' => 'ajax_pagination_settings',
        ) );
    ...
    public function addSettings($wp_customize){
        ...
        $checkboxOptions = array(
            'label' => __('Enable loading effects', 'ajax-pagination-more'),
            'default' => 1,
        ...
        $imageOptions = array(
            'label' => __('Spinner image', 'ajax-pagination-more'),
        ...
        $rangeOptions = array(
            'label' => __('Spinner size (px)', 'ajax-pagination-more'),
            'min' => 20,
            'max' => 200,
            'step' => 1,
            'default' => 60,
        ...
        $colorOptions = array(
            'label' => __('Background color', 'ajax-pagination-more'),
            'choices' => array(
                'none' => __('None', 'ajax-pagination-more'),
                'black' => __('Black', 'ajax-pagination-more'),
                'white' => __('White', 'ajax-pagination-more'),
            ),
            'default' => 'black',
            'section' => 'wpap_loading_effects',
            'active_callback' => array( $this, 'isLoadingEffects' )
        ...
        $rangeOptions = array(
            'label' => __('Opacity', 'ajax-pagination-more'),
            'min' => 0,
            'max' => 1,
            'step' => 0.1,
            'default' => 0.4,
        ...
        $colorOptions = array(
            'label' => __('Text color', 'ajax-pagination-more'),
            'default' => '',
            'section' => 'wpap_button_settings'
        );
        ...
        $checkboxOptions = array(
            'label' => __('Button text', 'ajax-pagination-more'),
            'default' => __('Load more', 'ajax-pagination-more'),
            'section' => 'wpap_button_settings'
        );
        $this->addSetting('wpap_button_text', 'text', $wp_customize, $checkboxOptions);

        $checkboxOptions = array(
            'label' => __('Bold text', 'ajax-pagination-more'),
            'default' => 0,
            'section' => 'wpap_button_settings'
        );
        ...
        $rangeOptions = array(
            'label' => __('Border radius (px)', 'ajax-pagination-more'),
            'min' => 0,
            'max' => 100,
            'step' => 1,
            'default' => 0,
        ...
        $rangeOptions = array(
            'label' => __('Button width (px)', 'ajax-pagination-more'),
            'min' => 0,
            'max' => 500,
            'step' => 1,
            'default' => 150,
        ...
        $rangeOptions = array(
            'label' => __('Button height (px)', 'ajax-pagination-more'),
            'min' => 0,
            'max' => 500,
            'step' => 1,
            'default' => 50,
        ...
        $checkboxOptions = array(
            'label' => __('Enable shadows', 'ajax-pagination-more'),
            'default' => 1,
            'section' => 'wpap_button_settings'
        );
        ...
        switch ($type) {
            ...
            case 'select':
                ...
                $wp_customize->add_control($name, array(
                    ...
                    'section' => $args['section'],
                    'label' => $args['label'],
                    'description' => __($args['description'], 'ajax-pagination-more'),
