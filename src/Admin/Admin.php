...
class Admin {
    ...
    public function registerActions(){
        ...
        add_filter('plugin_action_links_ajax-pagination-more/ajax-pagination-more.php', array($this, 'PluginActionLinks'));
    ...
    public function showAssets() {
        if ( is_admin() && get_current_screen()->id == 'settings_page_ajax-pagination-more-admin') {
            $this->showStyles();
            $this->showScripts();
        }
    }
    ...
    {
        $action_links = array(
            'settings' => '<a href="' . admin_url('admin.php?page=ajax-pagination-more-admin') .
                '" aria-label="' . esc_attr__('Ajax Pagination', 'ajax-pagination-more') .
                '">' . esc_html__('Settings', 'ajax-pagination-more') .
                '</a>');
    ...
    public function addMenuPage()
    {
        ...
        add_options_page(
            __('Ajax Pagination', 'ajax-pagination-more'),
            __('Ajax Pagination', 'ajax-pagination-more'),
            'edit_theme_options',
            'ajax-pagination-more-admin',
    ...
    public function optionsPage()
    {
        ...
        $tabs['settings'] = __('Settings', 'ajax-pagination-more');
        $tabs['instructions'] = __('Instructions', 'ajax-pagination-more');
